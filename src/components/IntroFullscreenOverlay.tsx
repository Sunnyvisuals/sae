        ...
        >
          ...
          <div className="relative z-10 flex w-full max-w-lg flex-col items-center px-8">
            <motion.span
              ...
              className="text-[9px] uppercase tracking-[0.52em] text-[#c5a059]/38"
            >
            ...
            <motion.div
              ...
              className="mt-8 flex w-full max-w-sm flex-col gap-3 sm:mt-10 sm:flex-row sm:justify-center sm:gap-4"
            >
              <button
                type="button"
                onClick={onAccept}
                className="group relative flex min-h-[3.25rem] flex-1 flex-col items-center justify-center overflow-hidden border border-[#c5a059]/45 bg-[rgba(197,160,89,0.08)] px-5 py-3 transition-[border-color,background-color,box-shadow] duration-500 hover:border-[#c5a059]/65 hover:bg-[rgba(197,160,89,0.12)]"
              >
                <span className="text-[10px] font-medium uppercase tracking-[0.28em] text-[#fdfaf6]/90">
              ...
              <button
                type="button"
                onClick={onLater}
                className="group relative flex min-h-[3.25rem] flex-1 flex-col items-center justify-center overflow-hidden border border-[#c5a059]/22 bg-transparent px-5 py-3 transition-[border-color,background-color] duration-500 hover:border-[#c5a059]/40 hover:bg-[rgba(197,160,89,0.06)]"
              >
                <span className="text-[10px] uppercase tracking-[0.22em] text-[#c5a059]/75">
            ...
            <motion.button
              ...
              onClick={onNever}
              className="mt-8 text-[9px] uppercase tracking-[0.28em] text-[#c5a059]/35 transition-colors hover:text-[#c5a059]/55"
            >
